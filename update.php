...
if (isset($_SESSION['key'])) {
  if (@$_GET['fdid'] && $_SESSION['key'] == 'ony08155509153') {
    $id = @$_GET['fdid'];
...
// hapus user
if (isset($_SESSION['key'])) {
  if (@$_GET['demail'] && $_SESSION['key'] == 'ony08155509153') {
    $demail = @$_GET['demail'];
...
// hapus ujian
if (isset($_SESSION['key'])) {
  if (@$_GET['q'] == 'rmquiz' && $_SESSION['key'] == 'ony08155509153') {
    $eid = @$_GET['eid'];
...
// tambah ujian
if (isset($_SESSION['key'])) {
  if (@$_GET['q'] == 'addquiz' && $_SESSION['key'] == 'ony08155509153') {
    $name = $_POST['name'];
...
//add question
if (isset($_SESSION['key'])) {
  if (@$_GET['q'] == 'addqns' && $_SESSION['key'] == 'ony08155509153') {
    $n = @$_GET['n'];
    $eid = @$_GET['eid'];
    $ch = @$_GET['ch'];
...
if (@$_GET['q'] == 'quiz' && @$_GET['step'] == 2) {
  ...
  } else if ($_SESSION['key'] != 'ony08155509153') {
